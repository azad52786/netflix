            ...
            >
                ...
                <div className=' flex justify-between w-full p-2 -mt-7'>
                    <div className=' flex gap-x-1 '>
                        <button className=' text-green-600 pl-[0.4rem] bg-opacity-50 bg-black  rounded-full h-5 w-5 cursor-pointer'>
                            <FaPlay className=' w-2 h-2'/>
                        </button>
                        <button className='  text-pink-700 pl-[0.4rem] bg-black bg-opacity-50 rounded-full  cursor-pointer h-5 w-5'>
                            <AiOutlineLike className=' w-2 h-2'/>
                        </button>
                        <button className=' text-yellow-500 pl-[0.4rem] bg-opacity-50 bg-black rounded-full  cursor-pointer h-5 w-5'>
                            <FaPlus className=' w-2 h-2'/>
                        </button>
                    </div>
                    <div>
                        <button className=' text-purple-500 pl-[0.4rem] bg-opacity-50 bg-black rounded-full cursor-pointer h-5 w-5'>
